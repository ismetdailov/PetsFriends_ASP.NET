    ...
    public partial class InitializeCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoverPictureLefts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoverPictureRights", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PetFriendId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friends_AspNetUsers_PetFriendId",
                        column: x => x.PetFriendId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    YearOld = table.Column<int>(type: "int", nullable: true),
                    MyHobby = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImLike = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Gender = table.Column<int>(type: "int", nullable: false),
                    ImHate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImLove = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImIterestedfor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MyOwnerIs = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MyFavoriteFood = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MyfamilyUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InformationAboutPets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InformationAboutPets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InformationAboutPets_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InformationAboutPets_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GroupIdId = table.Column<int>(type: "int", nullable: false),
                    PetId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyGroups", x => new { x.PetId, x.GroupIdId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_AspNetUsers_PetId",
                        column: x => x.PetId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PhotoAsBytes = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    PostId = table.Column<int>(type: "int", nullable: true),
                    Extension = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsProfilePictuire = table.Column<bool>(type: "bit", nullable: false),
                    IsCoverPictuireLeft = table.Column<bool>(type: "bit", nullable: false),
                    IsCoverPictuireRight = table.Column<bool>(type: "bit", nullable: false),
                    RemoteImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AlbumId = table.Column<int>(type: "int", nullable: true),
                    AddedByPetId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Pictures_AspNetUsers_AddedByPetId",
                        column: x => x.AddedByPetId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InformationAboutPets_CityId",
                table: "InformationAboutPets",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_InformationAboutPets_CountryId",
                table: "InformationAboutPets",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_InformationAboutPets_IsDeleted",
                table: "InformationAboutPets",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_InformationAboutPets_UserId",
                table: "InformationAboutPets",
                column: "UserId");
