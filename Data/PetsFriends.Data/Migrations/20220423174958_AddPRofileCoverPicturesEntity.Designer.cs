...
namespace PetsFriends.Data.Migrations
{
    ...
    [Migration("20220423174958_AddPRofileCoverPicturesEntity")]
    partial class AddPRofileCoverPicturesEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetsFriends.Data.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PetsFriends.Data.Models.GroupOnUser", b =>
                {
                    b.Property<string>("PetId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PetsFriends.Data.Models.Messages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReciverPetId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime>("SendedOn")
                        .HasColumnType("datetime2");

                    b.Property<int?>("UserMessagesMessageId")
                        .HasColumnType("int");

                    b.Property<string>("UserMessagesPetId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ReciverPetId");

                    b.HasIndex("UserMessagesPetId", "UserMessagesMessageId");
            ...
            modelBuilder.Entity("PetsFriends.Data.Models.UserMessages", b =>
                {
                    b.Property<string>("PetId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PetsFriends.Data.Models.Messages", b =>
                {
                    ...
                    b.HasOne("PetsFriends.Data.Models.ApplicationUser", "ReciverPet")
                        .WithMany()
                        .HasForeignKey("ReciverPetId");

                    b.HasOne("PetsFriends.Data.Models.UserMessages", null)
                        .WithMany("Messages")
                        .HasForeignKey("UserMessagesPetId", "UserMessagesMessageId");

                    b.Navigation("Group");

                    b.Navigation("Pet");

                    b.Navigation("ReciverPet");
                });
            ...
            modelBuilder.Entity("PetsFriends.Data.Models.UserMessages", b =>
                {
                    b.HasOne("PetsFriends.Data.Models.Messages", "Message")
                        .WithMany()
                    ...
                    b.HasOne("PetsFriends.Data.Models.ApplicationUser", "Pet")
                        .WithOne("UserMessages")
                        .HasForeignKey("PetsFriends.Data.Models.UserMessages", "PetId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("PetsFriends.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("CoverPicturesLeft");
                    ...
                    b.Navigation("coverPicturesRight");
                });
